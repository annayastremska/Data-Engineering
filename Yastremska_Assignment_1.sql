...
select
    ...
    count(*) as rows,
    count(*) - count(*) filter (where description is not null) as nulls,
    count(*) - count(distinct description) as dupes
from info_table
union all
select 'licenses_table', count(*), count(*) - count(*) filter (where license_id is not null), count(*) - count(distinct license_id) from licenses_table
union all
select 'images_table', count(*), count(*) - count(*) filter (where image_id is not null), count(*) - count(distinct image_id) from images_table
union all
select 'categories_table', count(*), count(*) - count(*) filter (where category_id is not null), count(*) - count(distinct category_id) from categories_table;